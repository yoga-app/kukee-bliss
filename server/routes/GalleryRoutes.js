...
router.post('/create', uploadMagic.single('picture'), (req, res, next) => {
  ...
  if(req.body.picture == '' || req.body.picture == 'null') {req.body.picture = 'https://images.unsplash.com/photo-1524863479829-916d8e77f114?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=220&h=200&fit=crop&ixid=eyJhcHBfaWQiOjF9'}
  if(req.body.video) {
